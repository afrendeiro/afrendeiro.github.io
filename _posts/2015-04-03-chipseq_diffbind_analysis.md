...
## [MANorm](https://bcb.dfci.harvard.edu/~gcyuan/MAnorm/MAnorm.htm)
- Requires peak files.
...
## [Odin](https://www.regulatory-genomics.org/odin-2/basic-introduction/)
...
## [ChIPDiff](https://cmb.gis.a-star.edu.sg/ChIPSeq/paperChIPDiff.htm)
- No documentation besides a readme in a zip file.
- Not really packaged.

## [DIME](https://www.stat.osu.edu/~statgen/SOFTWARE/DIME/)
- Poor documentation (only function description in the [R package](https://cran.r-project.org/web/packages/DIME/)).


## [DBChIP](https://pages.cs.wisc.edu/~kliang/DBChIP/)
- Useful tutorial.
