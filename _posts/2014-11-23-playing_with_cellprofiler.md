...
<div class="centerImages">
    <img src={{ site.url }}"/data/figures/concatenated_plots.png"
         align="middle" style="width: 700px;"/>
</div>
...
<div class="centerImages">
    <img src={{ site.url }}"/data/figures/correlation_plots.png"
...
<div class="centerImages">
    <img src={{ site.url }}"/data/figures/single_cell_density.png"
         align="middle" style="width: 500px;"/>
</div>
...
<div class="centerImages">
    <img src={{ site.url }}"/data/figures/pcas.png"
         align="middle" style="width: 500px;"/>
</div>
